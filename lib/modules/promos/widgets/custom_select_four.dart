...
class CustomSelectFour extends StatefulWidget {
  final List<CustomModel> list;

  const CustomSelectFour({Key? key, required this.list}) : super(key: key);

  @override
  _CustomSelectFourState createState() => _CustomSelectFourState();
}

class _CustomSelectFourState extends State<CustomSelectFour> {
