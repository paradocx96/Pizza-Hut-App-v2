...
class CustomSelectFive extends StatefulWidget {
  final List<CustomModel> list;

  const CustomSelectFive({Key? key, required this.list}) : super(key: key);

  @override
  _CustomSelectFiveState createState() => _CustomSelectFiveState();
}

class _CustomSelectFiveState extends State<CustomSelectFive> {
