...
class CustomSelectSix extends StatefulWidget {
  final List<CustomModel> list;

  const CustomSelectSix({Key? key, required this.list}) : super(key: key);

  @override
  _CustomSelectSixState createState() => _CustomSelectSixState();
}

class _CustomSelectSixState extends State<CustomSelectSix> {
