...
class CustomSelectTwo extends StatefulWidget {
  final List<CustomModel> list;

  const CustomSelectTwo({Key? key, required this.list}) : super(key: key);

  @override
  _CustomSelectTwoState createState() => _CustomSelectTwoState();
}

class _CustomSelectTwoState extends State<CustomSelectTwo> {
